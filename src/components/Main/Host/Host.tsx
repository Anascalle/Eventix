...
const HostEvents: React.FC<HostEventsProps> = ({ date, id, name, invitations, color }) => {
  ...
  const handleButtonClick = () => {
    ...
    navigate(`/detail/${id}`, { state: { id, userType: "Host" } });
  };
  ...
  return (
    <div id="hosts_events" style={{ backgroundColor: color }}>
      <div id="invitations">
        {invitations.length > 0 ? (
          ...
          <p id="guest_text_h">There are no guests</p>
        )}
