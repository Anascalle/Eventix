...
import "./Nav.css";
import InvitationsAccept from "../AceptedInvitations/AceptedInvitations"; // Asegúrate de que esta ruta esté correcta

const Nav2: React.FC = () => {
  const { userId } = useParams<{ userId: string }>();
  const { user } = useUser(); // Obtener los datos del usuario desde el contexto
